            ...
            <Row className="w-100">
              {!!filteredMandor.data &&
                filteredMandor.data.map((items) => (
                    ...
                    <Col className="text-start mb-3" id="listMandor" xs={12} lg={12}>
                      <Row>
                        <Col xs={12} lg={8}>
                          <Row className="">
                            <Col className="text-center py-3" xs={12} lg={3}>
                              <img 
                              alt=""
                              id="listMandorAvatar"
                            ...
                            <Col className="text-center text-lg-start pt-2 pt-lg-5">
                        ...
                        <Col className="align-self-end text-center text-lg-end p-3 pt-4">
                          <Button  variant="dark" onClick={()=>{triggerMandorDetails(items)}} >Lihat Profil</Button>
                          <Button id="bg-highlight3" onClick={()=>{mandorSelected(items._id)}}  className="ms-3 border border-none w-25">Pilih</Button>
                        </Col>
                      </Row>
                    </Col>
                ))
